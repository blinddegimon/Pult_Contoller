...
################################################################################
## Form generated from reading UI file 'settingsdialogWCpBkw.ui'
##
...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.gridLayout.addWidget(self.serialPortInfoListBox, 1, 0, 1, 1)
        ...
        self.updatePButton = QPushButton(self.selectBox)
        self.updatePButton.setObjectName(u"updatePButton")
        icon = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.SyncSynchronizing))
        self.updatePButton.setIcon(icon)

        self.gridLayout.addWidget(self.updatePButton, 0, 0, 1, 1)
