...
################################################################################
## Form generated from reading UI file 'controlDEnUkk.ui'
##
...
class Ui_ControlWindow(object):
    def setupUi(self, ControlWindow):
        ...
        self.pb_arr = QPushButton(ControlWindow)
        self.pb_arr.setObjectName(u"pb_arr")
        self.pb_arr.setCheckable(True)

        self.horizontalLayout_2.addWidget(self.pb_arr)

        self.pb_rarr = QPushButton(ControlWindow)
        self.pb_rarr.setObjectName(u"pb_rarr")
        self.pb_rarr.setCheckable(True)

        self.horizontalLayout_2.addWidget(self.pb_rarr)
    ...
    def retranslateUi(self, ControlWindow):
        ...
        self.pb_arr.setText(QCoreApplication.translate("ControlWindow", u"ARR", None))
        self.pb_rarr.setText(QCoreApplication.translate("ControlWindow", u"RARR", None))
